...
<!DOCTYPE html>
<html class="no-js">
<head> <title>禁用用户 - 后台管理 -TerBlog </title></head>
    ...
    <div class="row-fluid">
        ...
        <div class="block">
            <div class="navbar navbar-inner block-header">
                <div class="muted pull-left">禁用用户</div>
            </div>
                    ...
                    <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                        ...
                        <c:forEach items="${users}" var="c" varStatus="status">
                            <tr class="active">
                                ...
                                <td>
                                    <button class="btn btn-primary btn-mini" onclick="window.location.href='${pageContext.request.contextPath}/user?id=${c.id}'">
                                        详情
                                    </button>
                                    ...
                                    <button class="btn btn-danger btn-mini" onclick="window.location.href='DeleteUser?UserId=${c.id}'">
                                        删除
                                    </button>
                                </td>
                            </tr>
