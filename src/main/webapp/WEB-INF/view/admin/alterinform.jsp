...
<!DOCTYPE html>
<html class="no-js">
<head> <title>修改 - 后台管理 -TerBlog </title></head>
...
<div class="row-fluid">
    ...
    <div class="block">
        <div class="navbar navbar-inner block-header">
            <div class="muted pull-left">修改通知</div>
        </div>
                ...
                <form class="form-horizontal" action="InNewInform" enctype="multipart/form-data" method="post">
                    <fieldset>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input class="input-xlarge focused" id="id" name="id" type="text" value="${inform.id}" readonly="readonly" >
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label" for="title">标题</label>
                            <div class="controls">
                                <input class="input-xlarge focused" id="title" name="title" type="text" value="${inform.title}">
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label" for="content">内容</label>
                            <div class="controls">
                                <input class="input-xlarge focused" id="content" name="content" type="text" value="${inform.content}">
                            </div>
                        </div>
                        <div class="control-group">
