...
<!DOCTYPE html>
<html class="no-js">
<head> <title>回收站 - 后台管理 -TerBlog </title></head>
    ...
    <div class="row-fluid">
        ...
        <div class="block">
            <div class="navbar navbar-inner block-header">
                <div class="muted pull-left">回收站</div>
            </div>
                    ...
                    <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                        ...
                        <c:forEach items="${articles}" var="c" varStatus="status">
                            <tr class="even gradeC">
                                ...
                                <td>${c.bz}</td>
                                <td>
                                    <button class="btn btn-primary btn-mini" onclick="window.location.href='OutRecycledArticle?ArticleId=${c.id}'">
                                        移出
                                    </button>
                                    ...
                                    <button class="btn btn-primary btn-mini" onclick="window.location.href='InDraftArticle?ArticleId=${c.id}'">
                                        草稿
                                    </button>
                                    <button class="btn btn-danger btn-mini" onclick="window.location.href='DeleteArticle?ArticleId=${c.id}'">
                                        删除
                                    </button>
                                </td>
                            </tr>
