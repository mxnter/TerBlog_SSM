        ...
        <tr class="warning">
            ...
            <td>
                <button class="btn btn-primary btn-large" data-toggle="modal" data-target="#myModal"
                        onclick="window.location.href='${pageContext.request.contextPath}/article?id=${c.id}'">
                    预览
                </button>
                <button class="btn btn-primary btn-large" data-toggle="modal" data-target="#myModal"
                ...
                <button class="btn btn-danger btn-large" data-toggle="modal" data-target="#myModal"
                        onclick="window.location.href='OutDraftArticle?ArticleId=${c.id}'">
                    发布
                </button>
            </td>
        </tr>
