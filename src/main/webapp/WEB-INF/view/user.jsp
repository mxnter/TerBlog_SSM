                ...
                <table align='center' border='1' cellspacing='0'>
                    <c:forEach items="${users}" var="c" varStatus="st">
                        <tr>
                            ...
                            <td>username</td><td>${c.username}</td>
                        </tr><tr>
                            <td>password</td><td>${c.password}</td>
                        </tr><tr>
                            <td>nickname</td><td>${c.nickname}</td>
                        </tr><tr>
                            <td>headportrait</td><td>${c.headportrait}</td>
                        </tr><tr>
                            <td>registrationdate</td><td>${c.registrationdate}</td>
                        </tr><tr>
                            <td>administrator</td><td>${c.administrator}</td>
                        </tr><tr>
                            <td>sex</td><td>${c.sex}</td>
                        </tr><tr>
                            <td>email</td> <td>${c.email}</td>
                        </tr><tr>
                            <td>phonenumber</td><td>${c.phonenumber}</td>
                        </tr><tr>
                            <td>signature</td><td>${c.signature}</td>
                        </tr>
                    </c:forEach>
                </table>
                <br><br><br><br><br>
