...
<c:forEach items="${users}" var="c" varStatus="status">
    <tr class="warning">
        ...
        <td>
            <button class="btn btn-primary btn-large" data-toggle="modal" data-target="#myModal" onclick="window.location.href='${pageContext.request.contextPath}/user?id=${c.id}'" >
                详情
            </button>
            ...
            <button class="btn btn-danger btn-large" onclick="window.location.href='RecycledArticles?ArticlesId=${c.id}'">
                停用
            </button>
            <button class="btn btn-danger btn-large" onclick="window.location.href='RecycledArticles?ArticlesId=${c.id}'">
                删除
