    ...
    <c:forEach items="${users}" var="c" varStatus="status">
        <tr class="warning">
            ...
            <td>
                ...
                <button class="btn btn-danger btn-large" onclick="window.location.href='StartUser?UserId=${c.id}'">
                    启用
                </button>
                <button class="btn btn-danger btn-large" onclick="window.location.href='DeleteUser?UserId=${c.id}'">
                    删除
                </button>
            </td>
        </tr>
